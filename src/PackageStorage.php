...
class PackageStorage
{
    ...
    public $replicateConfig = [
        'sourcePackage' => 'yiisoft/template',
        'sourceFiles' => [
    ...
    public function __construct($file = '/../packages.local.php')
    {
        if (file_exists($localFile = __DIR__ . $file)) {
            $this->packages = array_merge($this->packages, require $localFile);
        }
    }
}
